...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.display_content.setGeometry(QtCore.QRect(15, 70, 375, 515))
        ...
        font.setWeight(50)
        self.display_content.setFont(font)
...
"color: rgb(0, 255, 0);"))
        ...
        self.bg_window.setPixmap(QtGui.QPixmap(_fromUtf8("receiver_bg.png")))
...
"color: rgb(0, 255, 0);"))
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(_translate("MainWindow", "Receiver", None))
