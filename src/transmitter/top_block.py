...
# Title: Top Block
# Generated: Wed Oct 25 20:05:50 2017
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.rrc_taps = rrc_taps = firdes.root_raised_cosine(nfilts, nfilts, 1.0/float(sps_slider), 0.35, 45*nfilts)
        ...
        # Blocks
        ##################################################
        self._volume_slider_range = Range(-1, 2, 0.1, 1, 1)
        ...
        self._sps_slider_range = Range(10, 80, 1, 45, 10)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, fc_slider, volume_slider, 0)

        ##################################################
        # Connections
        ##################################################
        self.connect((self.analog_sig_source_x_0, 0), (self.blocks_multiply_xx_0, 1))    
        self.connect((self.blks2_packet_decoder_0, 0), (self.qtgui_freq_sink_x_0, 0))    
        self.connect((self.blks2_packet_decoder_0, 0), (self.qtgui_time_sink_x_0_0, 0))    
        self.connect((self.blks2_packet_encoder_0, 0), (self.digital_constellation_modulator_0, 0))    
        self.connect((self.blks2_tcp_source_0, 0), (self.blks2_packet_decoder_0, 0))    
        ...
        self.connect((self.blocks_complex_to_real_1, 0), (self.qtgui_freq_sink_x_0_0_0, 0))    
    ...
    def set_sps_slider(self, sps_slider):
        ...
        self.set_rrc_taps(firdes.root_raised_cosine(self.nfilts, self.nfilts, 1.0/float(self.sps_slider), 0.35, 45*self.nfilts))
    ...
    def set_volume_slider(self, volume_slider):
        ...
        self.analog_sig_source_x_0.set_amplitude(self.volume_slider)
